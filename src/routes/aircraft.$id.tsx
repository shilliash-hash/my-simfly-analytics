...
import { Coins, TrendingUp, Users, Percent, ArrowLeft, MapPin } from "lucide-react";
...
function AirportDetail() {
  ...
  return (
    <AppShell>
      ...
      <PageHeader
        eyebrow={a.icao}
        title={identity?.name ?? a.name}
        description={`${identity?.country ?? a.country} · ${a.tierLabel}${
          identity?.level ? ` · L${identity.level}` : ""
