  ...
  head: () => ({
    meta: [
      ...
      { title: "MySimFly Assets Analysis" },
      {
        name: "description",
        content:
          "Live dashboard for SimFly.io airport owners — track levels, tiers, PAX earnings, fleet activity, and community rankings.",
      },
      ...
      { name: "description", content: "Analytical HUB for SimFly assets by shill" },
      { property: "og:description", content: "Analytical HUB for SimFly assets by shill" },
      { name: "twitter:description", content: "Analytical HUB for SimFly assets by shill" },
